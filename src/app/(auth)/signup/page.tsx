...
const BENEFITS = [
  "5 free content packages per month",
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary via-secondary to-accent items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative text-white max-w-md">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            <h2 className="font-display text-4xl font-bold mb-6">Start Creating Amazing Content Today</h2>
            <p className="text-white/80 mb-8 leading-relaxed">
              Join 50,000+ creators who use Content.ai to produce viral-worthy content across every platform.
            </p>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="w-full max-w-md">
          ...
          <p className="text-muted-foreground mb-8">Start creating amazing content for free</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input type="text" placeholder="Your name" value={name} onChange={(e) => setName(e.target.value)} className="pl-10 h-12" required />
              </div>
            </div>
            <div className="space-y-2">
